    ...
    <body>
      ...
      >
        ...
        <div style="font-size: 60px; color: #184ae7; margin: 38px 0 58px 0">
          <!-- <b>MyManager</b> -->
          <img src=${data.logo === '' ? './assets/logo.png' : data.logo} alt="">
        </div>
        <div
        ...
        ">Review & Pay</a>
          <div>
            <span style="color: #636464; font-size: 18px; text-align: center"
              >Powered by My Manager</span
            >
          </div>
        </div>
        <div
...
exports.organizationEmailTemplate = ({...data})=>{
  ...
  <body style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"> 
    <div class="es-wrapper-color" style="background-color:#FAFAFA"><!--[if gte mso 9]>
       <p>Activate your organization ${data.orgName}</p>
       <p>${data.message}</p>
       <p>organization details </p>
       <p>email: ${data.email}</p>
       <p>contact: ${data.contact}</p>
       <p>address: ${data.address}</p>
       <a href=${data.url}>ACTIVATE</a>
...
exports.organizationInvitationEmailTemplate = ({...data})=>{
  ...
  <body style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"> 
    <div class="es-wrapper-color" style="background-color:#FAFAFA"><!--[if gte mso 9]>
       <p>Hi ${data.name},</p>
       <p>You are invited to ${data.orgName}</p>
       <p>${data.message}</p>
       <p>Please click bellow link to join the organization </p>
       
       <a href=${data.url}>JOIN Now</a>
