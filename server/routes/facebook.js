...
router.get("/facebook/get-page-posts/:access_token/:pageId", get_pages_post);
router.get("/facebook/get-page-posts/comments/:access_token/:postId", comments_by_eachpost);
router.post("/facebook/create-page-posts", create_post);
router.post("/facebook/comment-on-post", comment_on_post);
