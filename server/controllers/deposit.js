...
// remove sms credits
exports.withdrawSMSAmount = async (req, res) => {
  let { user_id, wallet, cretits } = req.body;
...
exports.withdrawMinsAmount = async (req, res) => {
  ...
  try {
    ...
    await client.incomingPhoneNumbers
      .create({
        ...
        smsUrl: `https://mymanager.com/api/text/listen-message/${req.body.purchased_Num}`,
      })
