...
exports.createNewFreezeTask = async (req, res) => {
  try {
...
exports.getFreezeTask = async (req, res) => {
  try {
...
exports.updateFreezeTask = async (req, res) => {
  try {
    const { taskId, startDate, endDate } = req.body;
    const alreadyTaskFreezeList = await FreezeTask.find({ taskId });
    if (alreadyTaskFreezeList.length > 0) {
...
exports.deleteFreezeTask = async (req, res) => {
  try {
