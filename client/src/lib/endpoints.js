export const ENDPOINTS = {
  ...
  //myjournal tab
  GET_MYJOURNAL_LIST: '/myjournal_category/get_journal_Category',
  GET_JOURNAL_LIST_BY_ID: '/myjournal/get_Journal_bycategory',
  CREATE_MY_JOURNAL: '/myjournal_category/create_journal_category',
  ...
  DELETE_JOURNAL_CATEGORY: '/myjournal_category/del_category',
  UPDATE_JOURNAL_CATEGORY: '/myjournal_category/update',
