...
import { checkoutProduct, deleteCartItem } from '../../store';

import useMessage from '../../../../lib/useMessage';

const CashPayment = (props) => {
  const [selectedMethod, setSelectedMethod] = useState('cash');
  const { total, products, client, dispatch, isCart, user, isPaid, setIsPaid } = props;
  ...
  const checkoutProductByCard = () => {
    ...
    dispatch(checkoutProduct(data)).then((res) => {
