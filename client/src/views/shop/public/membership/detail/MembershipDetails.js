  ...
  return (
    <Row className="my-2">
      <Col md="7" xs="12">
        ...
        <CardText>
          Duration:
          <span className="text-primary ms-25">
            {data.duration_time} {data.duration_type}
          </span>
        </CardText>
        <CardText>
        ...
        <div className="d-flex flex-column flex-sm-row pt-1">
          <Link to={`/ecommerce/checkout/membership/${data._id}`}>
            {!isInCart(data._id) ? (
              <Button tag={'button'} className="btn-cart me-0 me-sm-1 mb-1 mb-sm-0" color="primary">
          ...
          <Link
            to={
              isInCart(data._id)
                ? `/ecommerce/checkout/membership`
                : `/ecommerce/membership-detail/${data._id}`
            }
          >
            <Button
              tag={'button'}
