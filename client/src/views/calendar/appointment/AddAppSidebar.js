...
const AddAppointment = (props) => {
  // ** Props
  const { calendarEventType, addAppointmentSidebarOpen, setAddAppointmentSidebarOpen } = props;
  ...
  const [invitedList, setInvitedList] = useState(inviteOptions[0]);
  ...
  const initState = () => {
    ...
    setInvitedList(inviteOptions[0]);
    setRemindTo('');
