        ...
        <div className="invoice-print p-3" id="pageContainer">
            ...
            <div>
              ...
              <p className="mb-25">
                {(data?.companyAddress?.city !== '' && data?.companyAddress?.city) ||
                  'San Diego County'}{' '}
                , {(data?.companyAddress?.state !== '' && data?.companyAddress?.state) || 'CA'},
                {(data?.companyAddress?.zipCode !== '' && data?.companyAddress?.zipCode) || '91905'}
                ,{data?.companyAddress?.country || 'USA'}
              </p>
              <p className="mb-0">
                {(data?.phone !== '' && data?.phone) || '+1 (123) 456 7891'},{' '}
                {(data?.alternatePhone !== '' && data?.alternatePhone) || '+44 (876) 543 2198'}
              </p>
            </div>
          ...
          <Row className="pb-2">
            <Col sm="6">
              ...
              <p className="mb-25">{data?.customer[0]?.fullName}</p>
              <p className="mb-25">{data?.customer[0]?.company}</p>
              <p className="mb-25">{data?.customer[0]?.address?.street}</p>
              <p className="mb-25">{data?.customer[0]?.contact}</p>
              <p className="mb-0">{data?.customer[0]?.email}</p>
            </Col>
                  ...
                  <tr key={i}>
                    <td className="py-1 ps-4">
                      <p className="fw-semibold mb-25">
                        {data?.products?.find((x) => x._id === item.itemId)?.product_name}
                      </p>
