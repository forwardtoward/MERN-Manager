...
export const progression = createSlice({
  ...
  reducers: {
    ...
    deleteCategoryForSmartList: (state, action) => {
      ...
      state.smartListRanking = state.smartListRanking.filter(item => item.category != action.payload)
    },
    deleteProgressionForSmartList: (state, action) => {
      state.smartListRanking = state.smartListRanking.filter(item => item.progression != action.payload)
    },
