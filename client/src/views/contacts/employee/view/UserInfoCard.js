...
const UserInfoCard = ({ selectedUser }) => {
  ...
  function submitHandler() {
    ...
    const newState = {
      ...state,
      employee_position: state.position
    };
    mutate(state);
                    ...
                    {selectedUser !== null ? (
                      <>
                        <Badge
                          color={
                            roleColors[
                              selectedUser?.role?.roleName ? selectedUser?.role?.roleName : 'other'
                            ]
                          }
            ...
            <Row className="gy-1">
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  className="react-select"
                  classNamePrefix="select"
                  options={employeePostion}
                  theme={selectThemeColors}
                  defaultValue={employeePostion[0]}
                  onChange={(_) =>
                    onchangeHandler({
                      target: {
                        name: 'position',
