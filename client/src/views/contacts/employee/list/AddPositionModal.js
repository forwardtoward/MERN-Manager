...
const AddPositionModal = ({ modal, toggle, positions, refetch, newPositions }) => {
  ...
  //       return position?.toLowerCase() === position?.toLowerCase();
  //     });
  ...
  const handleSubmit = (e) => {
    ...
    const employeePosition = { position: position };
