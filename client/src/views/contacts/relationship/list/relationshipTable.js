...
const CustomHeader = ({
  ...
  return (
    <div className="invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75">
      ...
      />
      {relationStore && relationStore.tags && (
        <AddNewTagModal
          open={openNewTag}
          store={relationStore}
          dispatch={dispatch}
      ...
      {relationStore && relationStore.leadSources && (
...
const LeadsList = ({ className, relationStore }) => {
    ...
    <Fragment>
      ...
      {row !== null && (
        <NoteModal
          ...
          isOpen={modal}
          row={row}
          notes={relationStore?.relationNote || []}
          dispatch={dispatch}
