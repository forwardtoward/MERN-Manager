...
const SidebarNewUsers = ({
  ...
  const handleChage = (e) => {
    ...
    setShowPosition(e?.target?.value === 'Business');
  };
    ...
    >
      <Form>
        ...
        <div className="mb-1" value={plan} onChange={(e) => setPlan(e.target.value)}>
          ...
          <Input onChange={handleChage} type="select" id="select-plan" name="select-plan">
        ...
        <div className={`mb-1 ${!showPosition && 'd-none'}`}>
        ...
        <div className={`mb-1 ${!showPosition && 'd-none'}`}>
          ...
          <div className={`d-flex justify-content-between gap-2 ${!showPosition && 'd-none'}`}>
            <Select
              className="flex-fill"
              isClearable={false}
