...
import NoteModal from '../list/Note';
...
const UserInfoCard = ({ selectedUser, notes }) => {
  // ** State
    ...
    <Fragment>
      ...
      <Card>
        <CardBody>
              ...
              <div className="d-flex flex-column align-items-center text-center">
                <div className="user-info">
                  <h4 className="d-flex">
                    ...
                    <div className="ms-1">
                      <FiEye className="cic-eye-icon" onClick={toggle} />
                    </div>
                  </h4>
                  {selectedUser !== null ? (
                    <>
          ...
          {selectedUser && (state.company || state.phone || state.email || selectedUser.address) ? (
