...
export const VendorNoteFetchAction = () => async (dispatch) => {
  try {
    const { data } = await api.vendorNoteList();
    dispatch(vendorNoteFetch(data));
  } catch (error) {}
};
export const VendorNoteAddAction = (newNote) => async (dispatch) => {
  try {
    const { data } = await api.vendorNoteAdd(newNote);
    dispatch(VendorNoteFetchAction());
  } catch (error) {}
};
export const VendorNoteDeleteAction = (id) => async (dispatch) => {
  try {
    const { data } = await api.vendorNoteDelete(id);
    dispatch(VendorNoteFetchAction());
  } catch (error) {}
};
export const VendorNoteEditAction = (newNote) => async (dispatch) => {
  try {
    const { data } = await api.vendorNoteEdit(newNote);
    dispatch(VendorNoteFetchAction());
  } catch (error) {}
};
