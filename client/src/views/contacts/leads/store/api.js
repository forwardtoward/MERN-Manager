...
export const leadNoteList = (_id) => {
  return API.get(`notes/followup_note/get_notes_by_user_id/${getUserId()}/${_id}`);
};
export const leadNoteAdd = (newnote, _id) => {
  return API.post(`notes/followup_note/add_note/${getUserId()}/${_id}`, newnote);
};
export const leadNoteDelete = (id) => {
  return API.delete('notes/followup_note/remove_note/' + id);
};
export const leadNoteEdit = (newnote) => {
