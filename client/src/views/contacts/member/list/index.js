...
const Members = () => {
  const memberStore = useSelector((state) => {return {...state.memberContact, tags : state.totalContacts.tags, leadSources:state.totalContacts.leadSource}});
