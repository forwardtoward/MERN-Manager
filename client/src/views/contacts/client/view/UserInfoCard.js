...
const UserInfoCard = ({ selectedUser, store, notes }) => {
  ...
  useEffect(() => {
    if (store && store.tags) {
      ...
      for (const src of store.leadSources) {
                  ...
                  {selectedUser !== null ? (
                    <>
                      ...
                      <Badge
                        ...
                        color={
                          store?.leadSources?.find((x) => x.title === selectedUser.leadSource)
                            ?.color
                        }
                      >
            ...
            <Button
              ...
              onClick={() => {
                let updatebleState = {
                  ...
                  note: selectedUser?.note,
                  tags: selectedUser?.tags,
                  leadSurce: selectedUser?.leadSource,
                  companyEmail: selectedUser?.companyEmail,
                  companyPhone: selectedUser?.companyPhone,
              ...
              <Col md={6} xs={12}>
                ...
                <div className="d-flex justify-content-between">
                  <Select
                    ...
                    onChange={(e) => {
                      setData((p) => ({ ...p, leadSource: e.value }));
                    }}
                  />
