    ...
    <Fragment>
      ...
      <ModalBody>
        <Form onSubmit={handleAdd}>
          ...
          <Input name="startDate"  required onChange={handleInput} value={editedData?.startDate} type="date" />
          <Label>End Date</Label>
          <Input name="endDate" required  onChange={handleInput} value={editedData?.endDate} type="date" />
          <hr />
          ...
          <div>
            ...
            <TabContent activeTab={activeTab}>
              <TabPane tabId="1">
                <Input required  name="vision" onChange={handleInput} value={editedData?.vision} type="textarea" />
              </TabPane>
              <TabPane tabId="2">
                <Input required  name="purpose" onChange={handleInput} value={editedData?.purpose} type="textarea" />
              </TabPane>
              <TabPane tabId="3">
                <Input required  name="obstacle" onChange={handleInput} value={editedData?.obstacle} type="textarea" />
              </TabPane>
              <TabPane tabId="4">
                <Input required  name="resource" onChange={handleInput} value={editedData?.resource} type="textarea" />
              </TabPane>
            </TabContent>
            <hr />
            <Label>Picture</Label>
