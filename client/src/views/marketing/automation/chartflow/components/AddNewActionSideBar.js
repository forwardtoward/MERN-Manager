    ...
    <div>
      ...
      {showWatchedPercentage &&
        ...
        >
          ...
          <ModalBody>
            What view percentage triggers a YES to watched?
            <Form>
              <div className='demo mt-1' onChange={onChangePercentOption}>
                ...
                <div className='form-check mt-1'>
                  ...
                  <Label className='form-check-label' for='unSetView'>
                    <h5>Don't Set View Percentage</h5>
                  </Label>
                </div>
              </div>
            </Form>
          ...
          <ModalFooter>
            ...
            <Button color='primary' outline onClick={() => onInsertConditionHandling()}>
              OK
            </Button>
          </ModalFooter>
        </Modal>
